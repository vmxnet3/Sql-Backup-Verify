...
Enter your SQL Server credentials and backup path in the panel to start verifying.
...
Uygulamayı başlatın: python run_app.py

Tarayıcıda açılan panelden SQL Server bilgilerinizi ve yedek yolunu girerek doğrulamayı başlatın.
